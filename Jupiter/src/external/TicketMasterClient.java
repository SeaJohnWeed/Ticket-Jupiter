...
public class TicketMasterClient {
	...
	private static final String API_KEY = "BN5AynvMcMTEtK80QfvbhEoanI3frsAh";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		String query = String.format("apikey=%s&latlong=%s,%s&keyword=%s&radius=%s",
				API_KEY, lat, lon, keyword, DEFAULT_RADIUS); // %s = 后面要加入的变量,类似Python的string format
